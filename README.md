...
<hr>
ลำดับของตัวแปรที่ใส่เข้ามาในฟังก์ชัน เช่น มีตัวแปร 5 ตัว เอาค่าที่ {5} มาแสดผลในข้อความ

<hr>
###คำถาม 5.2  ถ้ามีการใช้ตัวเลขใน { } ที่กระโดด เช่น {0} {2} {3} จะใช้งานได้หรือไม่ อย่างไร จงอธิบาย
<hr>
ใช้งานได้ถ้ามีตัวแปรเพียงพอต่อตำแหน่งที่กำหนดเช่น  Console.WriteLine("{0},{2},{3}", 5,8,6,9,7,10);

โดยนับตัวแปรตำแหน่งแรกเป็นตำแหน่งที่ 0,1,2... 

แต่จะใช้งานไม่ได้ก็ต่อเมื่อมีตัวแปรไม่เพียงพอต่อตำแหน่งที่กำหนดเช่น Console.WriteLine("{0},{2},{3}", 5,8,6);

ซึ่งมีตัวแปรอยู่แค่ 2 ตำแหน่งคือ 0 1 2 แต่เราจะนำข้อมูลตำแหน่งที่ 3 มาแสดงผลซึ่งไม่มีค่าอะไรเก็บอยู่
<hr>
...
<hr>
Console.WriteLine("{0,0}",1 ); ใน { , } คือ การกำหนด row, column ส่วน ,1

คือให้แสดงผลเลข 1 ตาม row, column ที่ได้กำหนด
<hr>
